...
class Step0010_Usecase extends MultiStep {
    ...
    constructor() {
                        ...
                        children: [
                            {
                                ...
                                children: [{
                                    title: `変換前`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/interface-mgt-cc/src/main/java/jp/co/nomura/onlineservice/cc/interfacemgt/usecase/AssetAllocationUsecase.java', 'utf-8'), 'java'),
                                }, {
                                    title: `変換後`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/go-interface-mgt-cc/domain/usecase/refactor_usecase_AssetAllocationUsecase.go', 'utf-8'), 'go'),
                                }]
                            },
                            {
        ...
        // this.fileNameList = getFilesRecursively('E:/workspace/NDP/git/interface-mgt-cc/src/main/java/jp/co/nomura/onlineservice/cc/interfacemgt/star/ext/usecase/').filter(filename => filename.endsWith('Usecase.java'));
        this.fileNameList = getFilesRecursively('E:/workspace/NDP/git/interface-mgt-cc/src/main/java/jp/co/nomura/onlineservice/cc/interfacemgt/usecase/').filter(filename => filename.endsWith('Usecase.java'));
        // childStepListを組み立て。
...
class Step0010_Controller extends MultiStep {
    ...
    constructor() {
                        ...
                        children: [
                            {
                                ...
                                children: [{
                                    title: `変換前`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/interface-mgt-cc/src/main/java/jp/co/nomura/onlineservice/cc/interfacemgt/app/rest/AssetListController.java', 'utf-8'), 'java'),
                                }, {
                                    title: `変換後`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/go-interface-mgt-cc/controller/AssetAllocationController.go', 'utf-8'), 'go'),
                                }]
                            },
                            {
                                title: `変換対象のjavaソースコード`,
        ...
        this.fileNameList = getFilesRecursively('E:/workspace/NDP/git/interface-mgt-cc/src/main/java/jp/co/nomura/onlineservice/cc/interfacemgt/app/rest/').filter(filename => filename.endsWith('Controller.java'));
        // childStepListを組み立て。
...
class Step0010_RestRepository extends MultiStep {
    ...
    constructor() {
                        ...
                        children: [
                            {
                                ...
                                children: [{
                                    title: `変換前`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/interface-mgt-cc/src/main/java/jp/co/nomura/onlineservice/cc/interfacemgt/infra/rest/repository/InterfaceV2CommonRestRepository.java', 'utf-8'), 'java'),
                                }, {
                                    title: `変換後`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/go-interface-mgt-cc/adapter/httpclient/InterfaceV2CommonRestRepository.go', 'utf-8'), 'go'),
                                }]
                            },
                            {
                                title: `変換対象のjavaソースコード`,
        ...
        this.fileNameList = getFilesRecursively('E:/workspace/NDP/git/interface-mgt-cc/src/main/java/jp/co/nomura/onlineservice/cc/interfacemgt/star/ext/infra/rest/repository/').filter(filename => filename.endsWith('Repository.java'));
        // childStepListを組み立て。
...
class Step0010_Refactor extends MultiStep {
    ...
    constructor() {
                        ...
                        children: [
                            {
                                ...
                                children: [{
                                    title: `リファクタリング前`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/go-interface-mgt-cc/domain/usecase/star_usecase_AccountDetailsUsecase_bef.go', 'utf-8'), 'go'),
                                }, {
                                    title: `リファクタリング後`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/go-interface-mgt-cc/domain/usecase/star_usecase_AccountDetailsUsecase.go', 'utf-8'), 'go'),
                                }]
                            },
                            {
        ...
        this.fileNameList = getFilesRecursively('E:/workspace/NDP/git/go-interface-mgt-cc/domain/usecase/').filter(filename => path.basename(filename).startsWith('star_') || path.basename(filename).startsWith('usecase_'));
        // childStepListを組み立て。
...
class Step0010_Refactor2 extends MultiStep {
    ...
    constructor() {
                        ...
                        children: [
                            {
                                ...
                                children: [{
                                    title: `リファクタリング前`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/go-interface-mgt-cc/adapter/httpclient/CommonTokenRefreshRestRepository.go_bef', 'utf-8'), 'go'),
                                }, {
                                    title: `リファクタリング後`,
                                    content: Utils.setMarkdownBlock(fs.readFileSync('E:/workspace/NDP/git/go-interface-mgt-cc/adapter/httpclient/CommonTokenRefreshRestRepository.go_aft', 'utf-8'), 'go'),
                                }]
                            },
                            {
                                title: `リファクタリング対象のソースコード`,
        ...
        this.fileNameList = getFilesRecursively('E:/workspace/NDP/git/go-interface-mgt-cc/adapter/httpclient/').filter(filename => path.basename(filename).endsWith('.go'));
        // childStepListを組み立て。
