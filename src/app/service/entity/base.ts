...
// update file_group_entity SET tenant_key='common';
// update file_body_entity SET tenant_key='common';
// update git_project_entity SET tenant_key='common';
// update content_part_entity SET tenant_key='common';
// update tool_call_group_entity SET tenant_key='common';
// update mm_file_entity SET tenant_key='common';
// update login_history_entity SET tenant_key='common';
// update user_entity SET tenant_key='common';
// update session_entity SET tenant_key='common';
// update invite_entity SET tenant_key='common';
// update department_entity SET tenant_key='common';
// update department_member_entity SET tenant_key='common';
// update o_auth_account_entity SET tenant_key='common';
// update team_entity SET tenant_key='common';
// update team_member_entity SET tenant_key='common';
// update predict_history_wrapper_entity SET tenant_key='common';
// update project_entity SET tenant_key='common';
// update message_cluster_entity SET tenant_key='common';
// update tool_call_part_entity SET tenant_key='common';
// update o_auth_provider_entity SET tenant_key='common';
// update tenant_entity SET tenant_key='common';
// update box_item_entity SET tenant_key='common';
// update file_tag_entity SET tenant_key='common';
// update file_version_entity SET tenant_key='common';
// update file_access_entity SET tenant_key='common';
// update vertex_cached_content_entity SET tenant_key='common';
// update mm_timeline_entity SET tenant_key='common';
// update mm_timeline_channel_entity SET tenant_key='common';
// update predict_history_entity SET tenant_key='common';
// update message_group_entity SET tenant_key='common';
// update message_entity SET tenant_key='common';
// update box_file_entity SET tenant_key='common';
// update box_file_body_entity SET tenant_key='common';
// update thread_group_entity SET tenant_key='common';
// update thread_entity SET tenant_key='common';
// update box_collection_entity SET tenant_key='common';
// update user_setting_entity SET tenant_key='common';
// update git_project_commit_entity SET tenant_key='common';
// update file_entity SET tenant_key='common';
